survey "Genomics survey" do
  ...
  section "Cell Line and Vector Information" do
    # multiple choice, 1 answer
  ...
  section "Special Instructions for Changing Cycling Parameters" do
    # multiple choice, 1 answer
  ...
  section "Enter Multiple Sample Information Below" do
