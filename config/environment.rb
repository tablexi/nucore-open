...
#
# Remove this require and the patch file itself after upgrading to Rails 4.1
...
if Rails.version < "4.1"
  ...
  raise "Remove the reference to the abstract_mysql_adapter patch in #{__FILE__} for Rails 4.1+"
end
