...
// Replace [token_id]
var pdfFileName = data.orderedForUsernname && data.nucoreOrderNumber ? 'Form Name' + data.orderedForUsernname + '_' + data.nucoreOrderNumber : 'document';
var fileToken = '[token_id]'; // PDF token

instance.label = 'Download PDF'; // change label
instance.redraw();
