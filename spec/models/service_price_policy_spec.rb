  ...
  context "test requiring services" do
    ...
    it "should create a price policy for today if no active price policy already exists" do
      ...
      ipp     = @service.service_price_policies.create(:unit_cost => 1, :unit_subsidy => 0, :start_date => Date.today - 7,
                                                 :price_group => @price_group, :restrict_purchase => false)
    ...
    it "should calculate the cost for an 1 service" do
      ipp   = @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today, :price_group_id => @price_group.id)
    ...
    it "should return a cost of nil if the purchase is restricted" do
      ipp = @service.service_price_policies.create(:restrict_purchase => true, :start_date => Date.today, :price_group_id => @price_group.id)
      ipp.calculate_cost_and_subsidy.should be_nil
    end

    it "should return the date for the current policies" do
      ipp = @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today - 7.days, :price_group_id => @price_group.id)
      ipp.save(false) #save without validations
      @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today + 7.days, :price_group_id => @price_group.id)
    ...
    it "should return the date for upcoming policies" do
      @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today, :price_group_id => @price_group.id)
      @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today + 7.days, :price_group_id => @price_group.id)
      @service.service_price_policies.create(:unit_cost => 10.75, :unit_subsidy => 0.75, :restrict_purchase => false, :start_date => Date.today + 14.days, :price_group_id => @price_group.id)
