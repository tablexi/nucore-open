...
//     // update split values
//       for let field in $('.split-cost')
//         const old_split = field.innerHTML.split("$")[1]
//         const percent = field.dataset.percent
//         const new_split = (total * percent) / 100
//         console.log("the split was " + old_split)
//         console.log("the split is " + new_split)
//         field.html("lets see")
//         field.innerHTML.replace(old_split, new_split.toFixed(2))
