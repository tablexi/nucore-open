class OldInstrumentPricePolicy < PricePolicy
  ...
  validates_presence_of :usage_rate, unless: ->(o) { o.reservation_rate || o.usage_subsidy.nil? || o.restrict_purchase? }
  validates_presence_of :reservation_rate, unless: ->(o) { o.usage_rate || o.reservation_subsidy.nil? || o.restrict_purchase? }
  ...
  after_create do |o|
    pgp = PriceGroupProduct.find_by(price_group_id: o.price_group.id, product_id: o.product.id)
