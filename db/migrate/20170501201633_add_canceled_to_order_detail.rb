class AddCanceledToOrderDetail < ActiveRecord::Migration
  def up
    ...
    Reservation.where.not(order_detail_id: nil, canceled_at: nil).find_each do |reservation|
      reservation.order_detail.assign_attributes(canceled_at: reservation.canceled_at,
