...
describe Facility do
  ...
  context 'can_pay_with_account?' do
    ...
    context 'purchase orders' do
      before :each do
        @account=Factory.create(:purchase_order_account, :account_users_attributes => @owner_attrs)
      end
    ...
    context 'credit cards' do
      before :each do
        @account=Factory.create(:credit_card_account, :account_users_attributes => @owner_attrs)
      end
